...
public:
    ...
    static void StartClientRecvThread();
    ...
    static HttpResponse DoWinHttpRequest(
    ...
    static void HandleDataReceived(BYTE fromSmallId, BYTE toSmallId,
